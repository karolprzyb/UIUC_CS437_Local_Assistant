...
class LightTransitionTransformer : public LightTransformer {
 public:
  ...
  // could maybe reset progress here so that the above calculations don't extend first frame of fade further beyond
  // start of fade and cause a jump in brightess?  Not sure if this does anything useful.  Just seeing slight jumps
  // in the beginning of some fades.
